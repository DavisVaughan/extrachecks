...
This note is also applicable if your function is marked internal (`@keywords internal`) and/or has no return value: "If a function does not return a value, please document that too, e.g. `\value{None}`."
</details>
